    ...
    <div class="col-4 center-v-h background">
      <div class="">
        ...
        <div class="background-form">
          <h4 class="text-center subrayado mb-30">
            <i class="ace-icon fa fa-users snip-light-blue color-1"></i>
            Acceso al sistemas
          </h4>
          <div class="form-group row m-b-20">
            <div class="col-12">
              ...
              <div class="input-group mb-3">
                <span class="input-group-addon"><i class="glyphicon glyphicon-user color-1"></i></span>
                <input id="usuario" type="text" class="form-control" name="usuario" placeholder="usuario" />
              </div>
            </div>
          </div>
          <div class="form-group row m-b-20 mb-30">
            <div class="col-12">
              <label for="password">Contraseña</label>
              <div class="input-group mb-3">
                <span class="input-group-addon"><i class="glyphicon glyphicon-lock color-1"></i></span>
