  ...
  <div class="row m-row-derecha">
    ...
    <div class="m-derecha">
      ...
      <div style="padding: 10px 15px">
        <h3 class="text-center">REGISTRO DE UGEL</h3>
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-user-lock"></i>&nbsp;DATOS</h5>
                  ...
                  <div class="modal-body">
                    <div class="row">
                      ...
                      <div class="col-4">
                        <div class="form-group">
                          <label for="exampleInputEmail1"><i class="fas fa-id-card"></i>&nbsp;CODIGO UNICO</label>
                          <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                        </div>
                      </div>
                      <div class="col-4">
                        <div class="form-group">
                          <label for="exampleInputEmail1"><i class="fas fa-id-card"></i>&nbsp;RUC</label>
                          <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-6">
                        <div class="form-group">
                          <label for="exampleInputEmail1"><i class="fas fa-id-card"></i>&nbsp;DIRECCIÓN</label>
                          <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-3">
                        <div class="form-group">
                          <label for="exampleInputEmail1"><i class="fas fa-id-card"></i>&nbsp;F. REGISTRO</label>
                          <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                        </div>
                      </div>
                      <div class="col-9">
                        <div class="form-group">
                          <label for="exampleInputEmail1"><i class="fas fa-id-card"></i>&nbsp;UBIGEO</label>
                          <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                        </div>
                      </div>
                    </div>
